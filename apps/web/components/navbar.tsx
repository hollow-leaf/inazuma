            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                        <li><a onClick={()=>router.replace('/buyer')}>Buyer</a></li>
                        <li>
                            <a>Parent</a>
                            <ul className="p-2">
                                <li><a>S1</a></li>
                        ...
                        <li><a onClick={()=>router.replace('/seller')}>Seller</a></li>
                    </ul>
                </div>
                <img src="favicon.ico" className="w-[90px] h-[90px]" alt="inazuma" />
...
>>>>>>> 25f5a6f (feat: frontend map leaflet)
        </div>
        <img
          src="favicon.ico"
