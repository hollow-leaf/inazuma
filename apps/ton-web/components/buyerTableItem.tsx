  ...
  return (
    <>
       <a key={props.index}className="group">
          ...
          <DetailButton Price={props.price} powerType={props.powerType} kWh={props.Generation_capacity} date={props.Date} status={true} provider={props.Provider} location={props.Location} Co2CID={props.cid} hyperCID={""} sequence={0} tokenId={props.address} sale={data.sale_address}/>
        </a>
    </>
  );
}
